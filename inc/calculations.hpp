...
geom_vector3 get_specular_intensity(const geom_vector3 &sphere_to_light_vec, const geom_vector3 &onsphere_vec, const geom_dot3 &view_center, const double view_light_pow);
